...
-- ------------ create table etl_mch_enrollment-----------------------
  ...
  CREATE TABLE kenyaemr_etl.etl_mch_antenatal_visit (
    ...
    encounter_id INT(11) NOT NULL PRIMARY KEY,
    provider INT(11),
    anc_visit_number INT(11), -- same as ANC Contacts
    anc_number VARCHAR(50),
    parity INT(11),
    gravidae INT(11),
    lmp_date DATE,
...
(
    ...
    type_of_sexual_violence             VARCHAR(255),
...
(
    ...
    admission_ward               INT(11),
    duration_of_hospital_stay    INT(11),
    psycho_social_support        VARCHAR(255),
    voided                       INT(11),
    CONSTRAINT FOREIGN KEY (patient_id)
        REFERENCES kenyaemr_etl.etl_patient_demographics (patient_id),
    CONSTRAINT unique_uuid UNIQUE (uuid),
...
CREATE TABLE kenyaemr_etl.etl_inpatient_admission
(
    patient_id              INT(11)  NOT NULL,
    visit_id                INT(11) DEFAULT NULL,
    encounter_id            INT(11)  NOT NULL PRIMARY KEY,
...
CREATE TABLE kenyaemr_etl.etl_inpatient_discharge
(
    patient_id             INT(11)  NOT NULL,
    visit_id               INT(11)  DEFAULT NULL,
    encounter_id           INT(11)  NOT NULL PRIMARY KEY,
