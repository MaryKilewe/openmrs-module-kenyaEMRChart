      ...
      from encounter e
        ...
        left outer join obs o on o.encounter_id=e.encounter_id and o.voided=0
                                 ...
                                 121764, 164933, 160080, 1823, 164940, 164934, 164935, 159615, 160288,1855, 164947, 162549,162877,160596,1109,162309,1113,1729,162737,159615,1120,163309,164936,1123,1124,1125,164937,1126,166607,159356,161011,165911,
                                                      167161,165086,164946,165287,164941)
      where e.voided=0 and e.date_created >= last_update_time
            or e.date_changed >= last_update_time
            or e.date_voided >= last_update_time
            or o.date_created >= last_update_time
...
CREATE PROCEDURE sp_update_etl_mch_postnatal_visit(IN last_update_time DATETIME)
  BEGIN
    ...
    ON DUPLICATE KEY UPDATE visit_date=VALUES(visit_date),encounter_id=VALUES(encounter_id),provider=VALUES(provider),pnc_register_no=VALUES(pnc_register_no),pnc_visit_no=VALUES(pnc_visit_no),delivery_date=VALUES(delivery_date),mode_of_delivery=VALUES(mode_of_delivery),place_of_delivery=VALUES(place_of_delivery),visit_timing_mother=VALUES(visit_timing_mother),visit_timing_baby=VALUES(visit_timing_baby),
      ...
      final_test_result=VALUES(final_test_result),hiv_test_type=VALUES(hiv_test_type),hiv_test_timing=VALUES(hiv_test_timing),
...
CREATE PROCEDURE sp_update_etl_vmmc_client_followup(IN last_update_time DATETIME)
  BEGIN
    ...
    ON DUPLICATE KEY UPDATE visit_date=VALUES(visit_date),
      ...
      days_since_circumcision=VALUES(days_since_circumcision),
      has_adverse_event=VALUES(has_adverse_event),
      adverse_event=VALUES(adverse_event),
      severity=VALUES(severity),
      adverse_event_management=VALUES(adverse_event_management),
...
ON DUPLICATE KEY UPDATE visit_date=VALUES(visit_date),provider=VALUES(provider),order_id=VALUES(order_id),urgency=VALUES(urgency),
    drug_concept_id=VALUES(drug_concept_id),drug_id=VALUES(drug_id),drug_name=VALUES(drug_name),frequency=VALUES(frequency),
...
BEGIN
    ...
    ON DUPLICATE KEY UPDATE provider=VALUES(provider),
                            ...
                            screening_site=VALUES(screening_site),
                            communication_mode=VALUES(communication_mode),
                            neonatal_risk_factor=VALUES(neonatal_risk_factor),
                            presence_of_comobidities=VALUES(presence_of_comobidities),
                            ...
                            nutritional_details=VALUES(nutritional_details),
...
BEGIN
    ...
    ON DUPLICATE KEY UPDATE provider=VALUES(provider),
        visit_date=VALUES(visit_date),
        contacted_by_pe_for_health_services=VALUES(contacted_by_pe_for_health_services),
        has_regular_non_paying_sexual_partner=VALUES(has_regular_non_paying_sexual_partner),
        number_of_sexual_partners=VALUES(number_of_sexual_partners),
        year_started_fsw=VALUES(year_started_fsw),
        year_started_msm=VALUES(year_started_msm),
        year_started_using_drugs=VALUES(year_started_using_drugs),
        trucker_duration_on_transit=VALUES(trucker_duration_on_transit),
        duration_working_as_trucker=VALUES(duration_working_as_trucker),
        duration_working_as_fisherfolk=VALUES(duration_working_as_fisherfolk),
        year_tested_discordant_couple=VALUES(year_tested_discordant_couple),
        ever_experienced_violence=VALUES(ever_experienced_violence),
        type_of_violence_experienced=VALUES(type_of_violence_experienced),
        ever_tested_for_hiv=VALUES(ever_tested_for_hiv),
        latest_hiv_test_method=VALUES(latest_hiv_test_method),
        latest_hiv_test_results=VALUES(latest_hiv_test_results),
        willing_to_test_for_hiv=VALUES(willing_to_test_for_hiv),
        reason_not_willing_to_test_for_hiv=VALUES(reason_not_willing_to_test_for_hiv),
        receiving_hiv_care=VALUES(receiving_hiv_care),
        hiv_care_facility=VALUES(hiv_care_facility),
        other_hiv_care_facility=VALUES(other_hiv_care_facility),
        ccc_number=VALUES(ccc_number),
        consent_followup=VALUES(consent_followup),
        date_created=VALUES(date_created),
        date_last_modified=VALUES(date_last_modified),
        voided=VALUES(voided);
...
BEGIN
    ...
    ON DUPLICATE KEY UPDATE provider=VALUES(provider),
    visit_date=VALUES(visit_date),
                            weight_taken=VALUES(weight_taken),
                            weight_not_taken_specify=VALUES(weight_not_taken_specify),
                            taking_arvs_everyday=VALUES(taking_arvs_everyday),
                            not_taking_arvs_everyday=VALUES(not_taking_arvs_everyday),
                            correct_dosage_per_weight=VALUES(correct_dosage_per_weight),
                            dosage_not_correct_specify=VALUES(dosage_not_correct_specify),
                            arv_dosage_frequency=VALUES(arv_dosage_frequency),
                            other_medication_dosage_frequency=VALUES(other_medication_dosage_frequency),
                            arv_medication_time=VALUES(arv_medication_time),
                            arv_timing_working=VALUES(arv_timing_working),
                            ...
                            difficulty_with_arv_tablets_or_liquids_specify=VALUES(difficulty_with_arv_tablets_or_liquids_specify),
                            othe_drugs_frequency_difficult_to_follow=VALUES(othe_drugs_frequency_difficult_to_follow),
                            difficult_other_drugs_to_follow_specify=VALUES(difficult_other_drugs_to_follow_specify),
                            difficulty_other_drugs_tablets_or_liquids=VALUES(difficulty_other_drugs_tablets_or_liquids),
                            difficulty_other_drugs_tablets_or_liquids_specify=VALUES(difficulty_other_drugs_tablets_or_liquids_specify),
                            arv_difficulty_due_to_taste_or_size=VALUES(arv_difficulty_due_to_taste_or_size),
                            arv_difficulty_due_to_taste_or_size_specify=VALUES(arv_difficulty_due_to_taste_or_size_specify),
                            arv_symptoms_on_intake=VALUES(arv_symptoms_on_intake),
                            laboratory_abnormalities=VALUES(laboratory_abnormalities),
                            laboratory_abnormalities_specify=VALUES(laboratory_abnormalities_specify),
                            summary_findings=VALUES(summary_findings),
                            severity_of_reaction=VALUES(severity_of_reaction),
                            reaction_seriousness=VALUES(reaction_seriousness),
                            reason_for_seriousness=VALUES(reason_for_seriousness),
                            action_taken_on_reaction=VALUES(action_taken_on_reaction),
                            reaction_resolved_on_dose_change=VALUES(reaction_resolved_on_dose_change),
                            reaction_reappeared_after_drug_introduced=VALUES(reaction_reappeared_after_drug_introduced),
                            laboratory_investigations_done=VALUES(laboratory_investigations_done),
                            outcome=VALUES(outcome),
                            reported_adr_to_pharmacy_board=VALUES(reported_adr_to_pharmacy_board),
                            name_of_adr=VALUES(name_of_adr),
                            adr_report_number=VALUES(adr_report_number),
     date_created=VALUES(date_created),
     date_last_modified=VALUES(date_last_modified);
...
-- Procedure sp_update_ATP Disclosure Readiness Assessment
DROP PROCEDURE IF EXISTS sp_update_etl_atp_disclosure_readiness_assessment $$
CREATE PROCEDURE sp_update_etl_atp_disclosure_readiness_assessment(IN last_update_time DATETIME)
BEGIN
   ...
   select e.uuid,
    ...
    ON DUPLICATE KEY UPDATE provider=VALUES(provider),
    visit_date=VALUES(visit_date),
                            entry_point_at_enrolment=VALUES(entry_point_at_enrolment),
                            other_entry_point_specify=VALUES(other_entry_point_specify),
                            who_brought_child_clinic=VALUES(who_brought_child_clinic),
                            who_else_lives_child_household=VALUES(who_else_lives_child_household),
                            gives_child_medication=VALUES(gives_child_medication),
                            knows_child_hiv_status=VALUES(knows_child_hiv_status),
                            other_house_member_has_hiv=VALUES(other_house_member_has_hiv),
                            family_member_taking_arvs=VALUES(family_member_taking_arvs),
                            discussed_informing_child_hiv_status=VALUES(discussed_informing_child_hiv_status),
                            discussion_outcome=VALUES(discussion_outcome),
                            child_told_why_come_clinic_or_medication=VALUES(child_told_why_come_clinic_or_medication),
                            questions_child_asking=VALUES(questions_child_asking),
                            care_giver_answer=VALUES(care_giver_answer),
                            child_ever_talk_about_hiv=VALUES(child_ever_talk_about_hiv),
                            what_does_child_say=VALUES(what_does_child_say),
                            child_doing_in_school=VALUES(child_doing_in_school),
                            child_like_school=VALUES(child_like_school),
                            child_have_friends=VALUES(child_have_friends),
                            child_behaviour_home=VALUES(child_behaviour_home),
                            worries_learning_hiv_status=VALUES(worries_learning_hiv_status),
                            disclosure_preference=VALUES(disclosure_preference),
...
CREATE PROCEDURE sp_update_etl_atp_taking_charge_tracking(IN last_update_time DATETIME)
BEGIN
   ...
   select e.uuid,
    ...
    visit_date=VALUES(visit_date),
                            ...
                            self_management=VALUES(self_management),
...
-- Procedure sp_update_ATP Transition readiness assessment
DROP PROCEDURE IF EXISTS sp_update_etl_atp_transition_readiness_assessment $$
CREATE PROCEDURE sp_update_etl_atp_transition_readiness_assessment(IN last_update_time DATETIME)
BEGIN
    SELECT "Processing ATP Transition readiness assessment";
    ...
    ON DUPLICATE KEY UPDATE provider=VALUES(provider),
    visit_date=VALUES(visit_date),
                            can_explain_hiv_is=VALUES(can_explain_hiv_is),
                            explain_how_arv_work=VALUES(explain_how_arv_work),
                            knows_name_of_arv=VALUES(knows_name_of_arv),
                            explain_what_means_suppressed_vl=VALUES(explain_what_means_suppressed_vl),
                            state_what_thier_vl_is=VALUES(state_what_thier_vl_is),
                            knows_they_virally_suppressed=VALUES(knows_they_virally_suppressed),
                            know_day_date_of_current_clinic_visit=VALUES(know_day_date_of_current_clinic_visit),
                            came_on_scheduled=VALUES(came_on_scheduled),
                            explain_what_to_do_missed_medication=VALUES(explain_what_to_do_missed_medication),
                            explain_where_to_seek_medical_care=VALUES(explain_where_to_seek_medical_care),
                            navigate_clinic_services_on_own=VALUES(navigate_clinic_services_on_own),
                            comfortable_comming_to_clinic=VALUES(comfortable_comming_to_clinic),
                            feels_not_conmfortable_coming_to_clinic_specify=VALUES(feels_not_conmfortable_coming_to_clinic_specify),
                            medical_problem_report_symptoms=VALUES(medical_problem_report_symptoms),
                            feel_free_ask_hcw_questions=VALUES(feel_free_ask_hcw_questions),
                            feel_free_ask_hcw_reproductive_health=VALUES(feel_free_ask_hcw_reproductive_health),
                            name_different_contraception=VALUES(name_different_contraception),
                            identify_one_person_to_seek_help=VALUES(identify_one_person_to_seek_help),
                            attends_peer_support_group=VALUES(attends_peer_support_group),
                            disclose_hiv_status_someone_else=VALUES(disclose_hiv_status_someone_else),
...
ON DUPLICATE KEY UPDATE provider=VALUES(provider),
        ...
        specific_complaint=VALUES(specific_complaint),
        disease_type=VALUES(disease_type),
        diabetes_condition=VALUES(diabetes_condition),
        ...
        tb_screening=VALUES(tb_screening),
        smoke_check=VALUES(smoke_check),
        date_stopped_smoke=VALUES(date_stopped_smoke),
        drink_alcohol=VALUES(drink_alcohol),
        date_stopped_alcohol=VALUES(date_stopped_alcohol),
        cessation_counseling=VALUES(cessation_counseling),
        physical_activity=VALUES(physical_activity),
        diet_routine=VALUES(diet_routine),
        examination_findings=VALUES(examination_findings),
        cardiovascular=VALUES(cardiovascular),
        respiratory=VALUES(respiratory),
        abdominal_pelvic=VALUES(abdominal_pelvic),
        neurological=VALUES(neurological),
        oral_exam=VALUES(oral_exam),
        foot_risk=VALUES(foot_risk),
        foot_low_risk=VALUES(foot_low_risk),
        foot_high_risk=VALUES(foot_high_risk),
        diabetic_foot=VALUES(diabetic_foot),
        treatment_given=VALUES(treatment_given),
        lifestyle_advice=VALUES(lifestyle_advice),
        nutrition_assessment=VALUES(nutrition_assessment),
        footcare_outcome=VALUES(footcare_outcome),
        clinical_notes=VALUES(clinical_notes),
        date_created=VALUES(date_created),
        date_last_modified=VALUES(date_last_modified),
        voided=VALUES(voided);
...
insert into kenyaemr_etl.etl_ncd_followup(
    patient_id,
    uuid,
    provider,
    visit_id,
...
ON DUPLICATE KEY UPDATE provider=VALUES(provider),
        ...
        drink_alcohol=VALUES(drink_alcohol),
        physical_activity=VALUES(physical_activity),
        healthy_diet=VALUES(healthy_diet),
        patient_complaint=VALUES(patient_complaint),
        specific_complaint=VALUES(specific_complaint),
        other_specific_complaint=VALUES(other_specific_complaint),
        examination_findings=VALUES(examination_findings),
        cardiovascular=VALUES(cardiovascular),
        respiratory=VALUES(respiratory),
        abdominal_pelvic=VALUES(abdominal_pelvic),
        neurological=VALUES(neurological),
        oral_exam=VALUES(oral_exam),
        foot_exam=VALUES(foot_exam),
        diabetic_foot=VALUES(diabetic_foot),
        foot_risk_assessment=VALUES(foot_risk_assessment),
        diabetic_foot_risk=VALUES(diabetic_foot_risk),
        adhering_medication=VALUES(adhering_medication),
        referred_to=VALUES(referred_to),
        reasons_for_referral=VALUES(reasons_for_referral),
        clinical_notes=VALUES(clinical_notes),
        date_created=VALUES(date_created),
...
BEGIN
    ...
    insert into kenyaemr_etl.etl_inpatient_discharge(
        patient_id,
        uuid,
        provider,
        visit_id,
